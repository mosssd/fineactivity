...
function page() {
  return (
    <div>
      ...
      <section id="Projects"
    className="w-fit mx-auto grid grid-cols-1 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-24 mb-5">
            ...
            <div className="px-4 py-3 w-72">
                ...
                <div className="flex items-center">
                    ...
                    <div className="ml-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="fill-gray-500 hover:fill-red-500 transition-all duration-300" viewBox="0 0 16 16">
                            <path 
