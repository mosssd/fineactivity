...
function ActivityPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(`/api/user/${userId}/recommend-activities-vectorsearch`);
                ...
                <div className="relative z-10">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" 
                        className={`hover:fill-red-400 transition-all duration-300 ${savedActivities[item.id] ? 'fill-red-500' : 'fill-gray-500'}`} viewBox="0 -1 15 15">
